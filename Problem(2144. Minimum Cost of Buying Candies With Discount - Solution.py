...
# the shop gives a third candy for free.  The customer can choose any
# candy to take away for free as long as the cost of the chosen candy
...
# candy with cost 1 for free, but not the candy with cost 4. Given a
# 0-indexed integer array cost, where cost[i] denotes the cost of the
